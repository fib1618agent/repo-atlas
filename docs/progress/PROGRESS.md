...
- **As of:** 2026-09-24 · branch `feat/atlas-marble-interaction` · HEAD `c576310` · working tree dirty (uncommitted Feature 004/005 work, docs, experiments).
- **Feature 004 (Engineering Relationship Graph):** BLOCKED. T001–T007 marked `[X]`; T008+ not started. `.specify/feature.json` points at `specs/005-…` (finished decision workstream).
