...
**Last verified:** 2026-09-24 16:58 +04:00 (R6 identity decisions applied to F004 docs, no status change; earlier: R4/R6 design reconciliation; earlier: R3–R6 amendments applied; earlier: R3–R6 local investigation; earlier: Feature 005 T049 / STOP GATE S5; `docs/AGENT-GOVERNANCE.md` inventory date)
...
| 006 | Feature 007 — Settings / Control Plane | Feature | NOT STARTED | UNKNOWN | UNKNOWN | 005 (004 implementation) | No `specs/007-*` artifacts; prerequisite gate on Feature 004 | Create SpecKit feature when authorized; no spec folder present | 2026-09-24 |
| 007 | Feature 006 — RepoAtlas MCP | Feature | NOT STARTED | UNKNOWN | UNKNOWN | 006 (planned control plane), 005 (004 graph) | No `specs/006-*` artifacts; related planning only in `sdd/08-mcp-agent-interface/` | Create SpecKit feature when authorized | 2026-09-24 |
...
Feature 004 — Engineering Relationship Graph  (BLOCKED at T007)
       ↓
Feature 007 — Settings / Control Plane  (NOT STARTED; no spec yet)
       ↓
Feature 006 — RepoAtlas MCP  (NOT STARTED; no spec yet)
```
